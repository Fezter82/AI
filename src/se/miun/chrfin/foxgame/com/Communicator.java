...
public class Communicator {
	...
	private void processMessage(String msg) {
		...
		System.out.println("Processing first recieved message: " + msg + " " + System.currentTimeMillis());
	...
	private void send(String... msgs) {
		try {
			for (String s : msgs) {
				...
				System.out.println("Sending message: " + s + " " + System.currentTimeMillis());
			}
			gameSink.flush();
			System.out.println("All messages sent" + System.currentTimeMillis());
		} catch (IOException e) {
